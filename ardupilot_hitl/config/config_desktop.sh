...
# Arrays de origens
origens=("$script_dir/ardupilot" "$script_dir/mavlink" "$script_dir/mavros/mavros_msgs" "$script_dir/mavros/msg" "$script_dir/mavros/mavros_extras" "$script_dir/mavros/plugins")
...
# Constrói o caminho completo do destino com base na pasta home do usuário
destino1="$HOME/$destino_relative1/modules/mavlink/message_definitions/v1.0"
